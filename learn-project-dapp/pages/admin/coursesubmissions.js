                      ...
                      <div className="flex flex-wrap  md:flex-none  justify-between text-center w-full items-center">
                        ...
                        <div>
                          <button className="text-xl  bg-transparent border-2 border-teal-500 rounded-2xl p-3 hover:bg-gradient-to-r from-teal-500 to-teal-400 font-semibold  ">
                            <Link
                              href={`/user/course/${course.attributes.slug}`}
                            >
                              Go To Course
                            </Link>
                          </button>
                            ...
                            <div class="modal-box bg-white dark:bg-zinc-800">
                              ...
                              <div class="modal-action">
                                <label
                                  ...
                                  for={"my-modal" + index}
                                  class=" cursor-pointer p-3 rounded-2xl bg-transparent border-2 border-red-500 hover:bg-gradient-to-r from-red-500 to-rose-400"
                                >
                                  Reject Course
                                </label>
                                <label
                                  onClick={() => setCourseFeedback("")}
                                  for={"my-modal" + index}
                                  class=" cursor-pointer p-3 rounded-2xl bg-transparent border-2 border-teal-500 hover:bg-gradient-to-r from-teal-500 to-teal-400"
                                >
                                  Cancel
                                </label>
                              </div>
