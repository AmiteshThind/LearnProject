  ...
  return (
    <div className=' min-h-screen flex flex-col   '>
      ...
      <div className='flex items-center justify-center     flex-grow py-5  - '>
        <h1 className="text-6xl text-white z-50 font-semibold ">Bringing Education To Defi</h1>
      </div>
      ...
      <div className='flex flex-grow  items-center justify-center  '>
        <button onClick={() => Router.push('/marketplace')} className="text-lg  z-50 m-5 py-6 lg:w-2/12 md:3/12 sm:w-full text-white bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-600 hover:bg-gradient-to-br focus:ring-4 focus:ring-green-300  dark:focus:ring-green-800 shadow-lg shadow-emerald-500/50 dark:shadow-lg dark:shadow-green-800/80 font-bold rounded-lg  px-5 text-center mr-2 mb-2">
          Start Learning
        </button>
        <button onClick={() => Router.push('/marketplace')} className=" text-lg z-50 m-5 py-6 lg:w-2/12 md:3/12 sm:w-full text-white bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-600 hover:bg-gradient-to-br focus:ring-4 focus:ring-green-300  dark:focus:ring-green-800 shadow-lg shadow-emerald-500/50 dark:shadow-lg dark:shadow-green-800/80 font-bold rounded-lg  px-5 text-center mr-2 mb-2">
