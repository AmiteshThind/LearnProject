      ...
      <div className="flex justify-center ">
        ...
        <div className="w-full justify-center flex flex-col items-center">
          ...
          <div className="  w-full mx-5 px-5 lg:w-1/2  mt-5  font-semibold">
            ...
            <textarea  onChange={(v) => setDescription(v.target.value)} value={description} class=" mt-2 textarea textarea-bordered h-[10rem] input-ghost w-full" placeholder="Brief description about yourself, expereince and what you teach. Make it fun and concise as students will be able to see this information."></textarea>
          </div>
          </div>
