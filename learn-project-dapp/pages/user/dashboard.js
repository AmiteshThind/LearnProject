...
function Dashboard() {
  ...
  return (
    <div className="  bg-fixed min-h-screen dark:bg-gradient-to-b dark:from-zinc-800    dark:via-emerald-700  dark:to-teal-500 bg-gradient-to-tr from-rose-200    via-teal-100  to-violet-200 text-zinc-700 dark:text-white ">
      ...
      {!isLoading ? (
        <div>
          <div className="flex justify-center ">
            ...
            <div className="w-3/4  bg-white dark:bg-zinc-800 rounded-3xl  flex-col mt-10">
              <div className="text-emerald-500 text-4xl font-extrabold pt-8 pb-4 px-8 mb-2 justify-center text-center ">
                My Courses
              </div>
              {isAuthenticated ? (
                    ...
                    <div className="w-full mx-5 my-3  ">
                      <div className="flex flex-wrap  justify-between items-center">
                        ...
                        <div
                          ...
                          className="btn bg-gradient-to-br  from-teal-500 to-emerald-500 border-none  hover:scale-95 my-3 sm:my-0 rounded-3xl font-bold  "
                        >
                          Go To Course
                        </div>
                      </div>
      ...
      <div>
      <AuthErrorMsg
        authErrorMsg={"Connect Wallet to see your courses"}
      />
    </div>}
    </div>
  );
