...
function Leaderboard() {
  ...
  return (
    <div className=" bg-fixed min-h-screen dark:bg-gradient-to-b dark:from-zinc-800    dark:via-emerald-700  dark:to-teal-500 bg-gradient-to-tr from-rose-200    via-teal-100  to-violet-200 dark:text-white text-zinc-700  ">
      <div>
              ...
              {isAuthenticated ? (
                <div className="mx-5 flex flex-wrap   justify-center my-8 ">
                  {students.map((student, index) => (
                    <div className="w-full border dark:border-zinc-600 border-zinc-200 p-3 rounded-3xl   my-3  ">
                      <div className="flex flex-wrap  justify-between items-center">
                        <div className="flex mx-5 w-full xl:w-1/4 justify-center items-center ">
                          <div className="text-3xl mr-2  xl:mr-5 font-extrabold text-emerald-500 ">
                            {index + 1}.
                          </div>
                          <div class="avatar">
