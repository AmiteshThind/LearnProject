        ...
        <form onSubmit={handleSubmit} className='m-5'>
            <div class="flex items-center  ">
                <div class="w-full flex flex-col   ">
                    <label class="font-semibold leading-none text-emerald-500">Course Name</label>
            ...
            <div>
                <div className="w-full flex flex-col mt-5  ">
                    <label class="font-semibold leading-none text-emerald-500">Description</label>
            ...
            <div class="flex items-center mt-5  ">
                <div class="w-full flex flex-col   ">
                    <label class="font-semibold leading-none text-emerald-500 ">Sections <span className='text-gray-400'>(Seperate by comma and include all sections in order)</span></label>
                    <input name='sections' value={values.sections} onChange={handleSections} required placeholder="eg. Setup, Config, Defi ... " type="text" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-emerald-500 mt-4 bg-gray-50 border rounded border-gray-200" />
                </div>
            </div>
            ...
            <div className="mt-5 mb-4 w-full flex-col  flex-stretch justify-start">
                ...
                <div className="flex">
                    <div className="flex flex-col mr-5 ">
                        <label className=" font-semibold leading-none mb-3 text-emerald-500 ">Category</label>
                        <div class="flex justify-center ">
                            <div class="mb-3 w-full">
