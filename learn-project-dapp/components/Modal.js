...
export default function Modal({visible,setVisible,setValues,values,handleAddLesson, uploading, uploadBtnText, handleVideo}) {
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start ">
                  ...
                  <div className="mt-3 divide-y w-full text-center item sm:mt-0 sm:ml-4 sm:text-left"> 
                    ...
                    <div className="mt-2">
                        <div className='mt-3'>
                            <AddLessonForm uploadBtnText={uploadBtnText} values={values} handleAddLesson={handleAddLesson} setValues={setValues} handleVideo={handleVideo}/>
                        </div>
                    </div>
                  </div>
                </div>
