...
function QuizAccordion({ children, section }) {
    ...
    return <div>
        <div onClick={() => setIsOpen(!isOpen)} className="flex transition transform hover:-translate-y-1 justify-between   border-2 border-emerald-500 mx-2 my-3  py-5 font-bold   rounded-2xl">
