...
function Accordion({ children, title, number }) {
    ...
    return <div>
        <div onClick={() => setIsOpen(!isOpen)} className="flex transition transform hover:-translate-y-1 justify-between  bg-transparent border-2 border-teal-500  mx-10  py-6 font-bold mt-5 rounded-2xl">
