  ...
  return (
    <Link href={`/course/${course.attributes.slug}`}>
      <div className=" container transform transition duration-500 hover:scale-105 cursor-pointer  ">
        <div className="card w-70   bg-white dark:bg-zinc-800  shadow-2xl">
          <figure>
            <Image
              width={650}
              height={400}
          ...
          <div class=" mx-5 my-5 p-2   ">
            <div class="badge bg-gradient-to-l from-teal-500    to-emerald-500  border-none px-4 py-4     truncate  ">
              {course.attributes.category}
            </div>
            <h3 className=" mt-4 text-sm   text-base-100 dark:text-white runcate">
              By {instructorUsername}
            </h3>
            <p class="font-semibold text-2xl mt-4  h-24    text-zinc-700 dark:text-white  line-clamp-3  ">
